...
"M = Plate: LMNO 457; Illegal Turn"
Uses the encryption function S = M^d mod n
The change from this an Problem6a.c is that '6' is now '7'.
*/
...
int main(){
	...
	//Original message
	char ascii_str[] = "Plate: LMNO 457; Illegal Turn";
	...
	//Convert hex message into BIGNUM
	BN_hex2bn(&M, hex_str);
